...
var texturedMaterial =new THREE.MeshPhongMaterial( { color: materialColor, envMap: textureCube,flatShading:false, side: THREE.DoubleSide } )
//var texturedMaterial = new THREE.MeshLambertMaterial( { color: materialColor, flatShading:false, side: THREE.DoubleSide } )

...
function createCar() {
    ...
    new THREE.MTLLoader().setPath('../res/Aventador/').load('Avent.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader(manager).setMaterials(materials).setPath('../res/Aventador/').load('Avent.obj', function (object) {
...
function createBackground() {
    ...
    var urls2 = [path2 + "px.jpg", path2 + "nx.jpg", path2 + "py.jpg", path2 + "ny.jpg", path2 + "pz.jpg", path2 + "nz.jpg"];
...
var vueApp = new _vue2.default({
    ...
    methods: {
        ...
        toggleinner: function toggleinner() {
